              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 14, right: 8, top: 16),
                      ...
                      Padding(
                        ...
                        child: ConstrainedBox(
                            constraints: const BoxConstraints(minWidth: 234, minHeight: 24),
                            child: const Text(
                              AppString.offers,
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => CustomCard(homeVM.data[index]),
